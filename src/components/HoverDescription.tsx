        ...
        <>
            ...
            {isHovered && createPortal(
                ...
                >
                    ...
                    {/* Triangle pointer */}
                    <div className="absolute left-1/2 -translate-x-1/2 -bottom-1.5 w-0 h-0 border-l-[5px] border-l-transparent border-r-[5px] border-r-transparent border-t-[5px] border-t-black/90"></div>
                </div>,
                portalRoot
            )}
        </>
